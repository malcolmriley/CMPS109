 ...
 *
 * Instead, the AI is supposed to evaluate various paths to the opponent's
 * side of the board and checks to see which particular hex cell has the
 * most paths through it. It dubs this the most valuable cell (to its
 * opponent) and places its piece there to block.
 *
 * Operative term: SUPPOSED TO.
 *
 * In reality, no part of this program works at all. I'm just turning
 * this in for some points rather than none.
 *********************************************************************/
